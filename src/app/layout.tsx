...
export const metadata: Metadata = {
  title: "Cristhian Victor Rojas Marquez | CS & SE Portfolio",
  description: "Personal website, software engineering portfolio, and computer science research portfolio of Cristhian Victor Rojas Marquez.",
};
        ...
        <header className="border-b border-[#1a1a1a] sticky top-0 bg-[#fafafa]/90 backdrop-blur-sm z-50">
          <div className="max-w-5xl mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <nav className="flex items-center flex-wrap gap-1 sm:gap-2 font-mono text-sm">
              ...
              <a href="/cv" className="px-2 py-1 border border-transparent hover:border-[#1a1a1a] hover:bg-[#1a1a1a]/5 transition-all">
                [cv]
              </a>
